...
export declare type ConnectorMode = 'ETH-live' | 'ETH-test-dockerized-geth' | 'ETH-test-embedded-ganache' | 'ETH-test-browser-window' | 'FAKE-test-embedded-mock' | 'ALGO-test-dockerized-algod';
