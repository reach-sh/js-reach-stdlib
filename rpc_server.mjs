  ...
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      ...
      return [2 /*return*/ , __assign(__assign(__assign({}, Object.assign.apply(Object, __spreadArray([{}], __read(['atomicUnit',
        ...
        balanceOf: function(id, tok) {
          return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  return [4 /*yield*/ , lib.balanceOf(account.id(id), tok)];
                case 1:
        ...
        minimumBalanceOf: function(id) {
          return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  return [4 /*yield*/ , lib.minimumBalanceOf(account.id(id))];
                case 1:
                  return [2 /*return*/ , _a.sent()];
              }
            });
        ...
        transfer: function(from, to, bal, tok) {
          return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a) {
...
export var mkReBigNumberify = function(l) {
  return function(n) {
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          rpc_acc = {
            ...
            tokenAccept: function(acc, tok) {
              return __awaiter(void 0, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/ , account.id(acc).tokenAccept(tok)];
                    case 1:
                      _a.sent();
            ...
            tokenAccepted: function(acc, tok) {
              return __awaiter(void 0, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/ , account.id(acc).tokenAccepted(tok)];
                    case 1:
                      return [2 /*return*/ , _a.sent()];
                  }
                });
            ...
            tokenMetadata: function(acc, tok) {
              return __awaiter(void 0, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/ , account.id(acc).tokenMetadata(tok)];
                    case 1:
                      return [2 /*return*/ , _a.sent()];
                  }
                });
            ...
            getInfo: function(id) {
              return __awaiter(void 0, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/ , contract.id(id).getInfo()];
                    case 1:
                      return [2 /*return*/ , _a.sent()];
                  }
                });
          ...
          mkRPC = function(olab, obj) {
            ...
            var _loop_2 = function(k) {
              router.post("/".concat(k), safely(function(req, res) {
                return __awaiter(void 0, void 0, void 0, function() {
          ...
          mkUserDefined = function(olab, prop, k, unsafe) {
            var router = express.Router();
            router.post(/^\/(.*)/, safely(function(req, res) {
              return __awaiter(void 0, void 0, void 0, function() {
          ...
          route_backend.post(/^\/getExports\/(.*)/, safely(function(req, res) {
            return __awaiter(void 0, void 0, void 0, function() {
              ...
              return __generator(this, function(_e) {
                switch (_e.label) {
                  ...
                  case 1:
                    return [4 /*yield*/ , _b.apply(_a, _c.concat([_e.sent()]))];
                  case 2:
                    b = _e.sent();
