...
void(_shared);
const _ETH_compiled = ETH_compiled;
void(_ETH_compiled);
const _CFX_compiled = CFX_compiled;
void(_CFX_compiled);
const _ETH = ETH;
void(_ETH);
const _CFX = CFX;
...
void(_ethers);
const _cfxers = cfxers;
void(_cfxers);
const _ETH_impl = ETH_impl;
void(_ETH_impl);
const _CFX_impl = CFX_impl;
void(_CFX_impl);
const _ETH_compiled_impl = ETH_compiled_impl;
void(_ETH_compiled_impl);
const _CFX_compiled_impl = CFX_compiled_impl;
