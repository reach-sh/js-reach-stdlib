...
import { mapRef, mapSet, copyMap, } from './shared_backend.mjs';
export var defineSimStuff = function() {
  var simMapDupe = function(sim_r, mapi, mapo) {
    sim_r.maps[mapi] = copyMap(mapo);
  };
  var simMapRef = function(sim_r, mapi, kt, k, vt) {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/ , mapRef(map, kt, k, vt)];
          case 2:
  ...
  var simMapSet = function(sim_r, mapi, kt, k, vt, v) {
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            sim_r.txns.push({ kind: 'mapOp', smr: { kind: kind, key: key, mbr: mbr } });
            return [4 /*yield*/ , mapSet(map, kt, k, vt, v)];
          case 3:
            return [2 /*return*/ , _b.sent()];
        }
      });
