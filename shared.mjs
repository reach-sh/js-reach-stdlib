...
let addressUnwrapper = (x) => x;
export const setAddressUnwrapper = (f) => { addressUnwrapper = f; };
...
export const addressEq = (x, y) => bytesEq(T_Address.canonicalize(x), T_Address.canonicalize(y));
