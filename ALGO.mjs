...
import { hex_to_buf, buf_to_arr, buf_to_hex, arr_to_buf, } from './CBR.mjs';
...
export var load = function() {
  ...
  var adjustTxnParams = function(who, srargs, ps) {
    return __awaiter(void 0, void 0, void 0, function() {
      return __generator(this, function(_a) {
        void who;
        void srargs;
  ...
  var makeLogRep = function(evt, tys) {
    ...
    var parse = function(log) {
      ...
      debug("parse", { log: log });
      // @ts-ignore
      var _a = __read(T_Tuple(__spreadArray([bytestringyNet(sigLen)], __read(tys), false)).fromNet(reNetify(log))),
        logb = _a[0],
        pd = _a.slice(1);
  ...
  var getApplicationBoxM = function(idn, name) {
    return __awaiter(void 0, void 0, void 0, function() {
  ...
  var getLocalState_ = function(addr, ApplicationID) {
    return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        contract = function(bin, givenInfoP) {
                        ...
                        return __generator(this, function(_v) {
                          switch (_v.label) {
                            case 0:
                              ...
                              return [4 /*yield*/ , getTxnParams(dhead)];
                            case 1:
                              return [4 /*yield*/ , _o.apply(void 0, _p.concat([_v.sent()]))];
                            case 2:
                              params = _v.sent();
                            ...
                            case 4:
                              return [2 /*return*/ , (_q.value = _v.sent(), _q)];
                            case 5:
                              _r = !soloSend;
                            ...
                            case 8:
                              return [2 /*return*/ , (_s.value = _v.sent(), _s)];
                            case 9:
                            ...
                            case 17:
                              return [2 /*return*/ , (_t.value = _v.sent(), _t)];
                            case 18:
                              if (timeoutAt) {
                            ...
                            case 20:
                              return [2 /*return*/ , (_u.value = _v.sent(), _u)];
                          }
                        });
                      };
                      _m.label = 10;
                      ...
                      getOutput = function(o_mode, o_lab, o_ctc, o_val) {
                        return __awaiter(void 0, void 0, void 0, function() {
                          ...
                          return __generator(this, function(_d) {
                            ...
                            } catch (e_13_1) { e_13 = { error: e_13_1 }; } finally {
                              try {
          ...
          var doAppOptIn = function(ctc) {
            return __awaiter(void 0, void 0, void 0, function() {
              return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return [4 /*yield*/ , doAccountAppOptIn(networkAccount, ctc)];
                  case 1:
                    return [2 /*return*/ , _a.sent()];
                }
              });
        ...
        appOptedIn = function(ctc) {
          return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  return [4 /*yield*/ , accountAppOptedIn(acc, ctc)];
                case 1:
                  return [2 /*return*/ , _a.sent()];
              }
            });
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            _b.label = 6;
          case 6:
            return [2 /*return*/ , assetHoldings.map(function(ah) { return bigNumberify(ah["asset-id"]); })];
        }
      });
    });
  };
  ...
  var doAccountAppOptedIn = function(nacc, ctcId) {
    return __awaiter(void 0, void 0, void 0, function() {
      var ls;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/ , getLocalState_(nacc, ctcId)];
          case 1:
            ls = _a.sent();
  ...
  var accountAppOptedIn = function(acc, ctc) {
    return __awaiter(void 0, void 0, void 0, function() {
      var addr;
      return __generator(this, function(_a) {
        switch (_a.label) {
  ...
  var doAccountAppOptIn = function(nacc, ctcId) {
    return __awaiter(void 0, void 0, void 0, function() {
      var dhead, _a, _b, _c, _d, _e, _f;
      return __generator(this, function(_g) {
        switch (_g.label) {
          case 0:
            return [4 /*yield*/ , doAccountAppOptedIn(nacc.addr, ctcId)];
          case 1:
            ...
            return [4 /*yield*/ , getTxnParams(dhead)];
          case 2:
            return [4 /*yield*/ , _a.apply(void 0, _b.concat([_c.apply(void 0, [_e.apply(_d, _f.concat([_g.sent(), bigNumberToNumber(ctcId),
              undefined, undefined, undefined, undefined,
              NOTE_Reach
            ]))])]))];
          case 3:
