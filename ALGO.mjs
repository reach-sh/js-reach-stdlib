...
import { stdContract, stdVerifyContract, stdAccount, debug, envDefault, argsSplit, makeRandom, replaceableThunk, ensureConnectorAvailable, bigNumberToBigInt, argMax, argMin, make_newTestAccounts, make_waitUntilX, checkTimeout, truthyEnv, Signal, Lock, retryLoop, } from './shared_impl.mjs';
      ...
      contract = function(bin, givenInfoP) {
              ...
              return __generator(this, function(_k) {
                switch (_k.label) {
                  ...
                  case 3:
                    ...
                    return [4 /*yield*/ , getTxnParams()];
                  case 4:
                    return [4 /*yield*/ , _a.apply(void 0, _b.concat([_c.apply(void 0, [_e.apply(_d, _f.concat([_k.sent(), algosdk.OnApplicationComplete.NoOpOC,
                      appApproval.result,
                      appClear.result,
                    ...
                    _loop_1 = function() {
                      ...
                      return __generator(this, function(_r) {
                        switch (_r.label) {
                          ...
                          case 3:
                            return [2 /*return*/ , (_l.value = _r.sent(), _l)];
                          case 4:
                            _m = !soloSend;
                          ...
                          case 6:
                            ...
                            return [4 /*yield*/ , doRecv(false, false)];
                          case 7:
                            return [2 /*return*/ , (_o.value = _r.sent(), _o)];
                          case 8:
                          ...
                          case 11:
                            ...
                            return [4 /*yield*/ , doRecv(false, false)];
                          case 12:
                            return [2 /*return*/ , (_p.value = _r.sent(), _p)];
                          case 13:
                            if (timeoutAt) {
                          ...
                          case 15:
                            return [2 /*return*/ , (_q.value = _r.sent(), _q)];
                        }
                      });
                    };
                    _k.label = 11;
        ...
        var setupEvents = function(a) {
          ...
          var createEventStream = function(event, tys) {
            ...
            var hashPrefix = sha512_256(sig).substring(0, 4);
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    ...
                    case 6:
                      ...
                      parsedLog = T_Tuple([T_Bytes(4)].concat(tys)).fromNet(reNetify(log));
