...
import { replaceableThunk, debug, stdContract, stdAccount, makeRandom, argsSplit, ensureConnectorAvailable, make_newTestAccounts, make_waitUntilX, checkTimeout, } from './shared_impl.mjs';
...
export function makeEthLike(ethLikeArgs) {
  ...
  var _d = replaceableThunk(function() { return validQueryWindowDefault; }),
    getValidQueryWindow = _d[0],
    setValidQueryWindow = _d[1];
  ...
  var _e = replaceableThunk(function() { return 0; }),
    _getQueryLowerBound = _e[0],
    _setQueryLowerBound = _e[1];
  ...
  // ****************************************************************************
  var _f = makeRandom(32),
    randomUInt = _f.randomUInt,
    hasRandom = _f.hasRandom;
                                    ...
                                    return __awaiter(_this, void 0, void 0, function() {
                                      ...
                                      return __generator(this, function(_b) {
                                        ...
                                        _loop_2 = function(l) {
                                          ...
                                          var _c = ethersC_1.interface.parseLog(l),
                                            name = _c.name,
                                            args = _c.args;
