...
import { assert, eq, } from './shared_backend.mjs';
import { replaceableThunk, debug, getViewsHelper, deferContract, makeRandom, argsSplit, ensureConnectorAvailable, make_newTestAccounts, make_waitUntilX, checkTimeout, } from './shared_impl.mjs';
...
export function makeEthLike(ethLikeArgs) {
        ...
        switch (_b.label) {
          ...
          case 3:
            ...
            attach = function(bin, infoP) {
              ...
              var getLog = function(fromBlock, toBlock, ok_evt) {
                return __awaiter(_this, void 0, void 0, function() {
                  return __generator(this, function(_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/ , eventCache.query(fromBlock, toBlock, ok_evt, getC)];
                      case 1:
                        return [2 /*return*/ , _a.sent()];
                    }
                  });
                  ...
                  return __generator(this, function(_c) {
                    switch (_c.label) {
                      ...
                      case 4:
                        ...
                        _c.label = 5;
                      case 5:
                        return [4 /*yield*/ , checkTimeout(getTimeSecs, timeoutAt, block_send_attempt)];
                      case 6:
                  ...
                  return __generator(this, function(_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                          ...
                          return __generator(this, function(_b) {
                            switch (_b.label) {
                              ...
                              case 10:
                                ...
                                _getLog_1 = function(l_evt, l_ctc) {
                                  return __awaiter(_this, void 0, void 0, function() {
                        ...
                        _a.label = 2;
                      case 2:
                        return [4 /*yield*/ , checkTimeout(getTimeSecs, timeoutAt, block_poll_start)];
                      case 3:
  ...
  var verifyContract = function(ctcInfo, backend) {
    return __awaiter(_this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/ , verifyContract_(ctcInfo, backend, new EventCache())];
          case 1:
            return [2 /*return*/ , _a.sent()];
        }
      });
  ...
  var verifyContract_ = function(ctcInfo, backend, eventCache) {
    return __awaiter(_this, void 0, void 0, function() {
