...
export function makeEthLike(ethLikeArgs) {
  ...
  var ethLikeCompiled = ethLikeArgs.ethLikeCompiled,
    ...
    validQueryWindow = ethLikeArgs.validQueryWindow;
  ...
  var _c = replaceableThunk(function() { return 0; }),
    _getQueryLowerBound = _c[0],
    _setQueryLowerBound = _c[1];
              ...
              var getLog = function(fromBlock, toBlock, ok_evt) {
                return __awaiter(_this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/ , eventCache.query('getLog', getC, fromBlock, ['time', bigNumberify(toBlock)], ok_evt)];
                      case 1:
                        res = _a.sent();
                        if (!res.succ) {
