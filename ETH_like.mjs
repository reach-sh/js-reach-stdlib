...
import { replaceableThunk, debug, stdContract, stdVerifyContract, stdAccount, makeRandom, argsSplit, ensureConnectorAvailable, make_newTestAccounts, make_waitUntilX, checkTimeout, makeEventQueue, makeEventStream, } from './shared_impl.mjs';
...
export function makeEthLike(ethLikeArgs) {
    ...
    return __awaiter(_this, void 0, void 0, function() {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          ...
          case 1:
            return [2 /*return*/ , _a.apply(void 0, [_d.sent()])];
          case 2:
                          ...
                          actualCall = function() {
                            return __awaiter(_this, void 0, void 0, function() {
                              return __generator(this, function(_a) {
                                switch (_a.label) {
                                  case 0:
                                    return [4 /*yield*/ , doCall(dhead + " callC::reach", ethersC, funcName, [arg], value, gasLimit, storageLimit)];
                                  case 1:
                                    return [2 /*return*/ , _a.sent()];
                                }
                              });
  ...
  var _e = __read(replaceableThunk(function() {
      return __awaiter(_this, void 0, void 0, function() {
        var _a;
        return __generator(this, function(_b) {
          switch (_b.label) {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 6:
            ...
            debug(dhead, { e0rec: e0rec, ctorArg: ctorArg });
            if (!ctorArg) {
