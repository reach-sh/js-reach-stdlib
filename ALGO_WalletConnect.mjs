...
var ALGO_WalletConnect = /** @class */ (function() {
  ...
  ALGO_WalletConnect.prototype.getAddr = function() {
    return __awaiter(this, void 0, void 0, function() {
      var accts;
      return __generator(this, function(_a) {
        switch (_a.label) {
  ...
  ALGO_WalletConnect.prototype.signTxns = function(txns) {
    return __awaiter(this, void 0, void 0, function() {
      var req, res, e_1;
      return __generator(this, function(_a) {
        switch (_a.label) {
...
export default ALGO_WalletConnect;;
