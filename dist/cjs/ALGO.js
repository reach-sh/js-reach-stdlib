...
var msgpack_1 = __importDefault(require("@msgpack/msgpack"));
...
var sendAndConfirm = function (stx_or_stxs) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5: return [4 /*yield*/, exports.waitForConfirmation(txID, untilRound)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    shared_impl_1.debug(msgpack_1["default"].decode(ret.tx));
                    return [2 /*return*/, ret];
                case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        didOptIn = function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ai = _a.sent();
                                        shared_impl_1.debug("didOptIn", ai);
                                                ...
                                                switch (_h.label) {
                                                    ...
                                                    case 7:
                                                        ...
                                                        if (e_5.type == 'sendRawTransaction') {
                                                            shared_impl_1.debug(dhead, '--- FAIL:', format_failed_request(e_5.e));
                                                        }
                                                        else {
                                                            shared_impl_1.debug(dhead, '--- FAIL:', e_5);
                                                        }
                        ...
                        views_bin = bin._getViews({ reachStdlib: ALGO_compiled_1.stdlib });
                                ...
                                return __awaiter(void 0, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 4:
                                                e_6 = _a.sent();
                                                shared_impl_1.debug('getApplicationById', e_6);
                                            ...
                                            case 5:
                                                ...
                                                _loop_3 = function (i) {
                                                    ...
                                                    shared_impl_1.debug({ viewSt: viewSt });
                                                    var vvni = base64ToUI8A(viewSt.bytes);
                                                    shared_impl_1.debug({ vvni: vvni });
                                                    if (vvni.length == 0) {
                                                ...
                                                try {
                                                    ...
                                                    shared_impl_1.debug("getView1", v, k, 'error', e);
                                                    return [2 /*return*/, ['None', null]];
                                                }
                                                return [2 /*return*/];
                                        }
