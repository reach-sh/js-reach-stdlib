...
exports.serveRpc = exports.mkReBigNumberify = exports.mkStdlibProxy = exports.mkKont = void 0;
...
var mkStdlibProxy = function (lib, ks) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        reBigNumberify = (0, exports.mkReBigNumberify)(lib);
...
var mkReBigNumberify = function (l) { return function (n) {
...
exports.mkReBigNumberify = mkReBigNumberify;
var mkKor = function (l, k) { return function (i) {
    return /^[0-9]+_[0-9a-f]{48}$/.test(i)
        ? k.id(i)
        : (0, exports.mkReBigNumberify)(l)(i);
}; };
