...
var makeArith = function (m) {
    ...
    var liftX2 = function (check) { return function (f, pre) {
        if (pre === void 0) { pre = undefined; }
        return function (a, b) { return check(doBN2(f, (0, CBR_1.bigNumberify)(a), (0, CBR_1.bigNumberify)(b), pre)); };
    }; };
    ...
    var mulPreC = function (max) { return ["mul overflow", function (x, y) { return x.eq((0, CBR_1.bigNumberify)(0)) || y.eq((0, CBR_1.bigNumberify)(0)) || x.lte(max.div(y)); }]; };
    ...
    var safeAdd256 = liftB('add', addPreC(exports.UInt256_max));
    ...
    var safeMul256 = liftB('mul', mulPreC(exports.UInt256_max));
    ...
    var muldiv = function (a, b, c) {
        ...
        return prod.div((0, CBR_1.bigNumberify)(c));
    };
...
var mkAddressEq = function (T_Address) { return function (x, y) {
    ...
    (0, exports.debug)('mkAddressEq', { x: x, y: y, cx: cx, cy: cy });
    return (0, shared_backend_1.bytesEq)(cx, cy);
}; };
