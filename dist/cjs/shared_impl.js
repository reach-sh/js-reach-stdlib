...
exports.mkAddressEq = exports.objectMap = exports.argsSplit = exports.argsSlice = exports.makeArith = exports.makeRandom = exports.hexToBigNumber = exports.hexToString = exports.makeDigest = exports.envDefault = exports.truthyEnv = exports.labelMaps = exports.memoizeThunk = exports.replaceableThunk = exports.deferContract = exports.getViewsHelper = exports.debug = exports.getDEBUG = exports.setDEBUG = exports.hexlify = void 0;
...
var debug = function () {
    ...
    if (exports.getDEBUG()) {
        ...
        var betterMsgs = msgs.map(function (msg) {
            return ["object", "array"].includes(typeof msg) && util_1["default"]
