...
exports.makeEthLike = exports.getQueryLowerBound = exports.setQueryLowerBound = void 0;
...
function makeEthLike(ethLikeArgs) {
    ...
    var sendRecv_prepArg = function (lct, args, tys, evt_cnt) {
        var _a = __read((0, shared_impl_1.argsSplit)(args, evt_cnt), 2), _args_svs = _a[0], args_msg = _a[1];
        var _b = __read((0, shared_impl_1.argsSplit)(tys, evt_cnt), 2), _tys_svs = _b[0], tys_msg = _b[1];
        void (_args_svs);
        void (_tys_svs);
        // @ts-ignore
    ...
    var getTxnTime = function (x) { return (0, shared_user_1.bigNumberify)(x.blockNumber); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, shared_impl_1.debug)(dhead, { address: address, fromBlock: fromBlock, qw: qw, howMany: howMany });
                    ...
                    case 4:
                        provider = _a.sent();
                        (0, shared_impl_1.debug)(dhead, { toBlock: toBlock, toBlock_act: toBlock_act });
                        logs = [];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, provider.getLogs({
                                fromBlock: (0, shared_user_1.bigNumberToNumber)(fromBlock),
                                toBlock: (0, shared_user_1.bigNumberToNumber)(toBlock_act),
                                address: address
                            })];
                    case 6:
                        logs = _a.sent();
    ...
    var makeLogRep = function (getCtcAddress, iface, evt, tys) {
        (0, shared_impl_1.debug)("makeLogRep", { evt: evt, tys: tys });
        var parse = function (log) {
            var address = log.address;
            var ctcAddress = getCtcAddress();
            (0, shared_impl_1.debug)("parse", { evt: evt, log: log, ctcAddress: ctcAddress, address: address });
            if (!addressEq(address, ctcAddress)) {
                return undefined;
            }
            var _a = iface.parseLog(log), name = _a.name, args = _a.args;
            (0, shared_impl_1.debug)("parse", { name: name, args: args });
            if (name !== evt) {
                return undefined;
            }
            if (tys === undefined) {
            ...
            (0, shared_impl_1.debug)("parse", { unargs: unargs });
            return unargs;
        };
        var parseA = function (txn) {
            ...
            try {
                for (var _b = __values(txn.logs), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var l = _c.value;
                    var p = parse(l);
                    (0, shared_impl_1.debug)("parseA", { l: l, p: p });
                    if (p) {
                        return p;
                    }
                }
    ...
    var _d = (0, shared_impl_1.makeRandom)(32), randomUInt = _d.randomUInt, hasRandom = _d.hasRandom;
    ...
    var doTxn = function (dhead, tp) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, shared_impl_1.debug)(dhead, { step: "pre call" });
                    return [4 /*yield*/, tp];
                case 1:
                    rt = _a.sent();
                    (0, shared_impl_1.debug)(dhead, { rt: rt, step: "pre wait" });
                    return [4 /*yield*/, rt.wait()];
                case 2:
                    rm = _a.sent();
                    (0, shared_impl_1.debug)(dhead, { rt: rt, rm: rm, step: "pre receipt" });
                    (0, shared_backend_1.assert)(rm !== null, "receipt wait null");
                    return [4 /*yield*/, fetchAndRejectInvalidReceiptFor(rm.transactionHash)];
                case 3:
                    ro = _a.sent();
                    (0, shared_impl_1.debug)(dhead, { rt: rt, rm: rm, ro: ro, step: "post receipt" });
                    return [2 /*return*/, ro];
            }
        });
    }); };
                            ...
                            var canIWin = function (lct) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 4:
                                            e_4 = _a.sent();
                                            (0, shared_impl_1.debug)(label, "canIWin", { e: e_4 });
                                            return [3 /*break*/, 5];
                                        case 5:
                                ...
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        ...
                                        case 2:
                                            ...
                                            (0, shared_impl_1.debug)(dhead, 'ARGS', args);
                                            arg = sendRecv_prepArg(lct, args, tys, evt_cnt);
                                            (0, shared_impl_1.debug)(dhead, 'START', arg);
                                            if (!(funcNum == 0)) return [3 /*break*/, 6];
                                            (0, shared_impl_1.debug)(dhead, "deploying");
                                                ...
                                                return __generator(this, function (_d) {
                                                    ...
                                                    try {
                                                        for (_a = __values(ok_r.logs), _b = _a.next(); !_b.done; _b = _a.next()) {
                                                            l = _b.value;
                                                            r = lr.parse(l);
                                                            (0, shared_impl_1.debug)(dhead, 'getOutput', l_evt, r);
                                                            if (r) {
                                                                return [2 /*return*/, r[0]];
                                                            }
                                                        }
                                        ...
                                        return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    ...
                                                    case 3:
                                                        e_8 = _a.sent();
                                                        (0, shared_impl_1.debug)('tokenMetadata', { f: f, m: m, e: e_8 });
                                                        return [3 /*break*/, 4];
    ...
    var _e = __read((0, shared_impl_1.replaceableThunk)(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var newTestAccounts = (0, shared_impl_1.make_newTestAccounts)(newTestAccount).serial;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    creationBlock = (0, shared_user_1.bigNumberify)(creation_time);
                    return [3 /*break*/, 5];
                case 4:
                    e_10 = _b.sent();
