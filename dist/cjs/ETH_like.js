...
var stdlib_sol_1 = __importDefault(require("./stdlib_sol"));
...
function makeEthLike(ethLikeArgs) {
    var _this = this;
    // ...............................................
    var ethLikeCompiled = ethLikeArgs.ethLikeCompiled, ethers = ethLikeArgs.ethers, _a = ethLikeArgs.standardDigits, standardDigits = _a === void 0 ? 18 : _a, providerLib = ethLikeArgs.providerLib, isIsolatedNetwork = ethLikeArgs.isIsolatedNetwork, isWindowProvider = ethLikeArgs.isWindowProvider, _getDefaultNetworkAccount = ethLikeArgs._getDefaultNetworkAccount, _getDefaultFaucetNetworkAccount = ethLikeArgs._getDefaultFaucetNetworkAccount, _b = ethLikeArgs._warnTxNoBlockNumber, _warnTxNoBlockNumber = _b === void 0 ? true : _b, standardUnit = ethLikeArgs.standardUnit, atomicUnit = ethLikeArgs.atomicUnit;
    var getProvider = providerLib.getProvider;
    var stdlib = ethLikeCompiled.stdlib;
    var T_Address = stdlib.T_Address, T_Tuple = stdlib.T_Tuple, addressEq = stdlib.addressEq;
    ...
    var initOrDefaultArgs = function (init) { return ({
        ...
        value: init ? init.value : shared_user_1.bigNumberify(0)
    }); };
    // ****************************************************************************
    // Event Cache
    // ****************************************************************************
    ...
    var EventCache = /** @class */ (function () {
        ...
        EventCache.prototype.query_ = function (fromBlock, toBlock, topic, getLogs) {
            return __awaiter(this, void 0, void 0, function () {
                var filterFn, initLogs, currentTime, _a, foundLogs;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            shared_impl_1.debug("EventCache.query", fromBlock, toBlock, topic);
                            ...
                            filterFn = function (x) {
                                return x.topics.includes(topic.toString())
                                    && x.blockNumber <= toBlock;
                            };
                            initLogs = this.cache.filter(filterFn);
                            if (initLogs.length > 0) {
                                shared_impl_1.debug("Found transaction in Event Cache");
                                return [2 /*return*/, getMinBlock(initLogs)];
                            }
                        ...
                        case 1:
                            currentTime = _b.sent();
                            _a = this;
                            return [4 /*yield*/, getLogs(this.currentBlock + 1)];
                        case 2:
                            _a.cache = _b.sent();
                            this.currentBlock =
                                (this.cache.length == 0)
                            ...
                            foundLogs = this.cache.filter(filterFn);
                            if (foundLogs.length < 1) {
                                return [2 /*return*/, undefined];
                            }
                            return [2 /*return*/, getMinBlock(foundLogs)];
                    }
                });
            });
        };
        EventCache.prototype.queryContract = function (fromBlock, toBlock, address, event, iface) {
            return __awaiter(this, void 0, void 0, function () {
                var topic, getLogs;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            topic = iface.getEventTopic(event);
                            getLogs = function (currentBlock) { return __awaiter(_this, void 0, void 0, function () {
                                var provider;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, getProvider()];
                            ...
                            return [4 /*yield*/, this.query_(fromBlock, toBlock, topic, getLogs)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        EventCache.prototype.query = function (fromBlock, toBlock, ok_evt, getC) {
            return __awaiter(this, void 0, void 0, function () {
                var ethersC, topic, getLogs;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ethersC = _a.sent();
                            topic = ethersC.interface.getEventTopic(ok_evt);
                            getLogs = function (currentBlock) { return __awaiter(_this, void 0, void 0, function () {
                                var provider;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
    ...
    // ****************************************************************************
    var _c = shared_impl_1.makeRandom(32), randomUInt = _c.randomUInt, hasRandom = _c.hasRandom;
    ...
    var doTxn = function (dhead, tp) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    shared_impl_1.debug(__assign(__assign({}, dhead), { step: "pre call" }));
                    return [4 /*yield*/, tp];
                case 1:
                    rt = _a.sent();
                    shared_impl_1.debug(__assign(__assign({}, dhead), { rt: rt, step: "pre wait" }));
                    return [4 /*yield*/, rt.wait()];
                case 2:
                    rm = _a.sent();
                    shared_impl_1.debug(__assign(__assign({}, dhead), { rt: rt, rm: rm, step: "pre receipt" }));
                    shared_backend_1.assert(rm !== null, "receipt wait null");
                    return [4 /*yield*/, fetchAndRejectInvalidReceiptFor(rm.transactionHash)];
                case 3:
                    ro = _a.sent();
                    shared_impl_1.debug(__assign(__assign({}, dhead), { rt: rt, rm: rm, ro: ro, step: "post receipt" }));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    shared_impl_1.debug(__assign(__assign({}, dpre), { step: "pre call" }));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        receiver = getAddr(to);
                        valueb = shared_user_1.bigNumberify(value);
                        dhead = { kind: 'transfer' };
                        if (!!token) return [3 /*break*/, 2];
                        txn = { to: receiver, value: valueb };
                        shared_impl_1.debug('sender.sendTransaction(', txn, ')');
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, doCall(dhead, tokCtc, "transfer", [receiver, valueb], shared_user_1.bigNumberify(0), gl)];
                    case 3: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    var connectAccount = function (networkAccount) { return __awaiter(_this, void 0, void 0, function () {
        ...
        function tokenAccept(token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    shared_impl_1.debug("tokenAccept: Unnecessary on ETH", token);
                    return [2 /*return*/];
                });
            });
        }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    deploy = function (bin) {
                        shared_impl_1.ensureConnectorAvailable(bin, 'ETH', reachBackendVersion, reachEthBackendVersion);
                        ...
                        var performDeploy = function (init) {
                            shared_impl_1.debug(shad, ': performDeploy with', init);
                            ...
                            shared_impl_1.debug(shad, ': making contract factory');
                            ...
                            (function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            shared_impl_1.debug(shad, ": deploying factory");
                                            return [4 /*yield*/, factory.deploy.apply(factory, __spreadArray(__spreadArray([], argsMay), [{ value: value, gasLimit: gasLimit }]))];
                                        case 1:
                                            contract = _a.sent();
                                            shared_impl_1.debug(shad, ": deploying factory; done:", contract.address);
                                            shared_impl_1.debug(shad, ": waiting for receipt:", contract.deployTransaction.hash);
                                            return [4 /*yield*/, contract.deployTransaction.wait()];
                                        case 2:
                                            deploy_r = _a.sent();
                                            shared_impl_1.debug(shad, ": got receipt;", deploy_r.blockNumber);
                        ...
                        var attachDeferDeploy = function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                shared_impl_1.debug(shad, ":", label, 'sendrecv m', funcNum, "(deferred deploy)");
                                                value = pay[0], toks = pay[1];
                                                // The following must be true for the first sendrecv.
                                                try {
                                                    shared_backend_1.assert(onlyIf, "verifyContract: onlyIf must be true");
                                                    shared_backend_1.assert(soloSend, "verifyContract: soloSend must be true");
                                                    shared_backend_1.assert(shared_backend_1.eq(funcNum, 1), "verifyContract: funcNum must be 1");
                                                    shared_backend_1.assert(!timeoutAt, "verifyContract: no timeout");
                                                    shared_backend_1.assert(toks.length == 0, "verifyContract: no tokens");
                                                }
                                                catch (e) {
                            ...
                            var impl = shared_impl_1.deferContract(true, implP, implNow);
                            return impl;
                        };
                    ...
                    attach = function (bin, infoP) {
                        ...
                        var _a = (function () {
                            ...
                            var setLastBlock = function (n) {
                                shared_impl_1.debug("lastBlock from", lastBlock, "to", n);
                                lastBlock = n;
                            };
                        ...
                        var callC = function (dhead, funcName, arg, pay) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ethersC = _a.sent();
                                        zero = shared_user_1.bigNumberify(0);
                                        ...
                                        callTok = function (tok, amt) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    ...
                                                    case 1:
                                                        tokBalance = _a.sent();
                                                        shared_impl_1.debug(__assign(__assign({}, dhead), { kind: 'token' }), 'balanceOf', tokBalance);
                                                        shared_backend_1.assert(tokBalance.gte(amt), "local account token balance is insufficient: " + tokBalance + " < " + amt);
                                                        tokCtc = new ethers.Contract(tok, ERC20_ABI, networkAccount);
                        ...
                        var getLog = function (fromBlock, toBlock, ok_evt) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, eventCache.query(fromBlock, toBlock, ok_evt, getC)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); };
                        ...
                        var sendrecv = function (srargs) { return __awaiter(_this, void 0, void 0, function () {
                            var funcNum, evt_cnt, tys, args, pay, out_tys, onlyIf, soloSend, timeoutAt, doRecv, funcName, dhead, _a, args_svs, args_msg, _b, tys_svs, tys_msg, arg_ty, arg, lastBlock, block_send_attempt, block_repeat_count, e_2, current_block, error;
                            var _this = this;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        ...
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ['ARGS', args]));
                                        _a = shared_impl_1.argsSplit(args, evt_cnt), args_svs = _a[0], args_msg = _a[1];
                                        _b = shared_impl_1.argsSplit(tys, evt_cnt), tys_svs = _b[0], tys_msg = _b[1];
                                    ...
                                    case 3:
                                        ...
                                        // https://github.com/reach-sh/reach-lang/issues/134
                                        _c.sent();
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ['START', arg]));
                                        return [4 /*yield*/, getLastBlock()];
                                    case 4:
                                        lastBlock = _c.sent();
                                        ...
                                        _c.label = 5;
                                    case 5: return [4 /*yield*/, shared_impl_1.checkTimeout(getTimeSecs, timeoutAt, block_send_attempt)];
                                    case 6:
                                        if (!!(_c.sent())) return [3 /*break*/, 16];
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ['TRY']));
                                        _c.label = 7;
                                    case 7:
                                        _c.trys.push([7, 9, , 14]);
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ['ARG', arg, pay]));
                                    ...
                                    case 9:
                                        ...
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ["SKIPPING", e_2]));
                                        return [3 /*break*/, 13];
                                    case 10:
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ["ERROR", e_2.stack]));
                                    ...
                                    case 12:
                                        ...
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ["TRY FAIL", lastBlock, current_block, block_repeat_count, block_send_attempt]));
                                        return [3 /*break*/, 5];
                                    case 13: return [3 /*break*/, 14];
                                    case 14: return [4 /*yield*/, doRecv(false)];
                                    ...
                                    case 16:
                                        ...
                                        // the timeout message.
                                        shared_impl_1.debug.apply(void 0, __spreadArray(__spreadArray([], dhead), ["FAIL/TIMEOUT"]));
                        ...
                        var recv = function (rargs) { return __awaiter(_this, void 0, void 0, function () {
                            var funcNum, out_tys, waitIfNotPresent, timeoutAt, isFirstMsgDeploy, lastBlock, ok_evt, dhead, block_poll_start_init, block_poll_start, block_poll_end, _loop_1, state_1;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        ...
                                        _loop_1 = function () {
                                            var ok_e, ok_r, ok_t, theBlock_1, ok_ed, ok_vals, data, _getLog_1, getOutput, theBlockBN, from, theSecsBN;
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    case 0:
                                                        shared_impl_1.debug(dhead, "GET", { block_poll_start: block_poll_start, block_poll_end: block_poll_end });
                                                        return [4 /*yield*/, eventCache.query(block_poll_start, block_poll_end, ok_evt, getC)];
                                                    case 1:
                                                        ok_e = _b.sent();
                                                        if (!(ok_e == undefined)) return [3 /*break*/, 6];
                                                        shared_impl_1.debug(dhead, "RETRY");
                                                    ...
                                                    case 3:
                                                        ...
                                                        return [4 /*yield*/, waitUntilTime(shared_user_1.bigNumberify(block_poll_end + 1))];
                                                    case 4:
                                                        _b.sent();
                                                        _b.label = 5;
                                                    case 5:
                                                    ...
                                                    case 6:
                                                        shared_impl_1.debug(dhead, "OKAY");
                                                        return [4 /*yield*/, fetchAndRejectInvalidReceiptFor(ok_e.transactionHash)];
                                                    case 7:
                                                        ok_r = _b.sent();
                                                        shared_impl_1.debug(dhead, 'ok_r', ok_r);
                                                        return [4 /*yield*/, getProvider()];
                                                    case 8: return [4 /*yield*/, (_b.sent()).getTransaction(ok_e.transactionHash)];
                                                    case 9:
                                                        ok_t = _b.sent();
                                                        shared_impl_1.debug(dhead, 'ok_t', ok_t);
                                                        // The .gas field doesn't exist on this anymore, apparently?
                                                        // debug(`${ok_evt} gas was ${ok_t.gas} ${ok_t.gasPrice}`);
                                                        if (ok_t.blockNumber) {
                                                            shared_backend_1.assert(ok_t.blockNumber == ok_r.blockNumber, 'recept & transaction block numbers should match');
                                                            if (ok_e.blockNumber) {
                                                                shared_backend_1.assert(ok_t.blockNumber == ok_e.blockNumber, 'event & transaction block numbers should match');
                                                            }
                                                        }
                                                        else {
                                                        ...
                                                        shared_impl_1.debug(dhead, "AT", theBlock_1);
                                                        updateLast(ok_r);
                                                        return [4 /*yield*/, getEventData(ok_evt, ok_e)];
                                                    case 10:
                                                        ok_ed = _b.sent();
                                                        shared_impl_1.debug(dhead, "DATA", ok_ed);
                                                        ok_vals = ok_ed[0][1];
                                                        shared_impl_1.debug(dhead, "MSG", ok_vals);
                                                        ...
                                                        shared_impl_1.debug(dhead, "OKAY", ok_vals);
                                                        theBlockBN = shared_user_1.bigNumberify(theBlock_1);
                                                        from = ok_t.from;
                                        ...
                                        _a.label = 2;
                                    case 2: return [4 /*yield*/, shared_impl_1.checkTimeout(getTimeSecs, timeoutAt, block_poll_start)];
                                    case 3:
                                    ...
                                    case 4:
                                        ...
                                        return [3 /*break*/, 2];
                                    case 5:
                                        shared_impl_1.debug(shad, ':', label, 'recv', ok_evt, timeoutAt, '--- TIMEOUT');
                                        return [2 /*return*/, { didTimeout: true }];
                                }
                            });
                        }); };
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        // @ts-ignore
                                        return [2 /*return*/, shared_user_1.bigNumberify(theCreationTime)];
                                }
                            });
                        }); };
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                shared_impl_1.debug('getView1', v, k, args, vkn);
                                                _a.label = 2;
                                            case 2:
                                                _a.trys.push([2, 4, , 5]);
                                            ...
                                            case 4:
                                                e_3 = _a.sent();
                                                shared_impl_1.debug('getView1', v, k, 'error', e_3);
                        ...
                        var getViews = shared_impl_1.getViewsHelper(views_bin, getView1);
                    ...
                    tokenMetadata = function (token) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                    ...
                                    go = function (f, m) {
                                        ...
                                        return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        shared_impl_1.debug('tokenMetadata', { f: f, m: m });
                                                        _a.label = 1;
                                                    case 1:
                                                        _a.trys.push([1, 3, , 4]);
                                                    ...
                                                    case 2:
                                                        v = _a.sent();
                                                        shared_impl_1.debug('tokenMetadata', { f: f, m: m, v: v });
                                                        md[f] = v;
                                                        return [3 /*break*/, 4];
                                                    case 3:
                                                        e_4 = _a.sent();
                                                        shared_impl_1.debug('tokenMetadata', { f: f, m: m, e: e_4 });
                                                        return [3 /*break*/, 4];
                                ...
                                case 5:
                                    _a.sent();
                                    shared_impl_1.debug("tokenMetadata", token, md);
                                    return [2 /*return*/, md];
                            }
                        });
                    }); };
    ...
    var getDefaultAccount = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    shared_impl_1.debug("getDefaultAccount");
    ...
    var _d = shared_impl_1.replaceableThunk(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var newTestAccount = function (startingBalance) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    shared_impl_1.debug('newTestAccount(', startingBalance, ')');
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    shared_impl_1.debug('newTestAccount awaiting transfer:', to);
                    return [4 /*yield*/, fundFromFaucet(acc, startingBalance)];
                case 4:
                    _a.sent();
                    shared_impl_1.debug('newTestAccount got transfer:', to);
                    return [2 /*return*/, acc];
                case 5:
                    e_5 = _a.sent();
    ...
    var newTestAccounts = shared_impl_1.make_newTestAccounts(newTestAccount);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, shared_user_1.bigNumberify(timestamp)];
            }
        });
    }); };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, await_timeout_1["default"].set(500)];
                case 4:
                    _b.sent();
                    _b.label = 5;
    ...
    var waitUntilTime = shared_impl_1.make_waitUntilX('time', getNetworkTime, stepTime);
    ...
    var waitUntilSecs = shared_impl_1.make_waitUntilX('secs', getNetworkSecs, stepSecs);
    ...
    var verifyContract = function (ctcInfo, backend) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, verifyContract_(ctcInfo, backend, new EventCache())];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
    var verifyContract_ = function (ctcInfo, backend, eventCache) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    shared_impl_1.debug('verifyContract', { address: address });
                    chk = function (p, msg) {
                        if (!p) {
                ...
                case 2:
                    now = _b.sent();
                    getLogs = function (event) { return __awaiter(_this, void 0, void 0, function () {
                        var log;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    shared_impl_1.debug('verifyContract: getLogs', { event: event, now: now });
                                    return [4 /*yield*/, eventCache.queryContract(0, now, address, event, iface)];
                                case 1:
                                    log = _a.sent();
                ...
                case 3:
                    ...
                    shared_impl_1.debug("verifyContract: checking code...");
                    return [4 /*yield*/, provider.getTransaction(e0log.transactionHash)];
                case 4:
                    dt = _b.sent();
                    shared_impl_1.debug('dt', dt);
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [3 /*break*/, 4];
                                    case 1: return [4 /*yield*/, getLogs('e1')];
                                    case 2:
                                        e1log = _b.sent();
                                        e1p = iface.parseLog(e1log);
                                        shared_impl_1.debug("e1p", e1p);
    ...
    function parseCurrency(amt) {
        return shared_user_1.bigNumberify(ethers_1.ethers.utils.parseUnits(amt.toString(), standardDigits));
    }
    ...
    function formatCurrency(amt, decimals) {
        ...
        var divAmt = shared_user_1.bigNumberify(amt)
            .div(shared_user_1.bigNumberify(10).pow(decimalsToForget));
    ...
    var ethLike = __assign(__assign(__assign({}, ethLikeCompiled), providerLib), { getFaucet: getFaucet,
        setFaucet: setFaucet,
