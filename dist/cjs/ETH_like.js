                    ...
                    tokenMetadata = function (token) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    lab = "tokenMetadata";
                                    (0, shared_impl_1.debug)(lab, token);
                                    ...
                                    get = function (t, m) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    (0, shared_impl_1.debug)(lab, { m: m });
                                                    return [4 /*yield*/, tokCtc[m]()];
                                                case 1:
                                                    rv = _a.sent();
                                                    (0, shared_impl_1.debug)(lab, { m: m, rv: rv });
                                                    v = t ? t.unmunge(rv) : rv;
                                                    (0, shared_impl_1.debug)(lab, { m: m, v: v });
                                                    return [2 /*return*/, v];
                                            }
                                        });
                                    }); };
                                        ...
                                        return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_c) {
                                                switch (_c.label) {
                                                    ...
                                                    case 2:
                                                        e_8 = _c.sent();
                                                        (0, shared_impl_1.debug)(lab, { f: f, m: m, e: e_8 });
                                                        return [3 /*break*/, 3];
                                ...
                                case 6:
                                    _b.sent();
                                    (0, shared_impl_1.debug)(lab, token, md);
                                    return [2 /*return*/, md];
                            }
                        });
                    }); };
