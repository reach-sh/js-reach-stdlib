...
function makeEthLike(ethLikeArgs) {
    ...
    var _e = __read((0, shared_impl_1.makeSigningMonitor)(), 2), setSigningMonitor = _e[0], notifySend = _e[1];
    ...
    var _f = __read((0, shared_impl_1.replaceableThunk)(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
