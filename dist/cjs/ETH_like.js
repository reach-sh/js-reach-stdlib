...
function makeEthLike(ethLikeArgs) {
    ...
    var fastForwardTo = function (targetTime, onProgress) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var actuallyWaitUntilTime = function (targetTime, onProgress) { return __awaiter(_this, void 0, void 0, function () {
        var onProg, provider;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            var onBlock = function (currentTimeNum) { return __awaiter(_this, void 0, void 0, function () {
                                var currentTime;
                                return __generator(this, function (_a) {
                                    currentTime = shared_user_1.bigNumberify(currentTimeNum);
                                    // Does not block on the progress fn if it is async
                                    onProg({ currentTime: currentTime, targetTime: targetTime });
                                    if (shared_backend_1.ge(currentTime, targetTime)) {
    ...
    var getDummyAccount = shared_impl_1.memoizeThunk(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var stepTime = function () { return __awaiter(_this, void 0, void 0, function () {
        var faucet, acc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    deploy = function (bin) {
                        ...
                        var attachDeferDeploy = function () {
                            ...
                            var implNow = {
                                stdlib: stdlib,
                                sendrecv: function (funcNum, evt_cnt, hasLastTime, tys, args, pay, out_tys, onlyIf, soloSend, timeout_delay, sim_p) { return __awaiter(_this, void 0, void 0, function () {
                                    var value, toks;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                try {
                                                    ...
                                                    shared_backend_1.assert(!timeout_delay, "verifyContract: no timeout");
                    ...
                    attach = function (bin, infoP) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ethersC = _a.sent();
                                        return [4 /*yield*/, getProvider()];
                                    case 2: return [4 /*yield*/, (_a.sent()).getLogs({
                                            fromBlock: fromBlock,
                                            toBlock: toBlock,
                        ...
                        var sendrecv_impl = function (funcNum, evt_cnt, hasLastTime, tys, args, pay, out_tys, onlyIf, soloSend, timeout_delay) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        doRecv = function (waitIfNotPresent) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, recv_impl(funcNum, out_tys, waitIfNotPresent, timeout_delay)];
                                                case 1: return [2 /*return*/, _a.sent()];
                                            }
                                        }); }); };
                                    ...
                                    case 4:
                                        ...
                                        _c.label = 5;
                                    case 5:
                                        if (!(!timeout_delay || shared_backend_1.lt(block_send_attempt, add(lastBlock, timeout_delay)))) return [3 /*break*/, 15];
                        ...
                        var sendrecv = function (funcNum, evt_cnt, hasLastTime, tys, args, pay, out_tys, onlyIf, soloSend, timeout_delay, sim_p) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        void (sim_p);
                        ...
                        var recv_impl = function (okNum, out_tys, waitIfNotPresent, timeout_delay) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        lastBlock = _a.sent();
                                        ok_evt = "e" + okNum;
                                        shared_impl_1.debug(shad, ':', label, 'recv', ok_evt, timeout_delay, "--- START");
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 9:
                                                        ...
                                                        if (ok_t.blockNumber) {
                                                            shared_backend_1.assert(ok_t.blockNumber == ok_r_1.blockNumber, 'recept & transaction block numbers should match');
                                                            if (ok_e.blockNumber) {
                                                        ...
                                                        shared_impl_1.debug(shad, ':', label, 'recv', ok_evt, "--- AT", ok_r_1.blockNumber);
                                                        updateLast(ok_r_1);
                                                        return [4 /*yield*/, getEventData(ok_evt, ok_e)];
                                                    case 10:
                                                        ok_ed = _b.sent();
                                                        shared_impl_1.debug(shad, ':', label, 'recv', ok_evt, "--- DATA --", ok_ed);
                                                        ok_vals = ok_ed[0][1];
                                                        ...
                                                        return [2 /*return*/, { value: {
                                                                    ...
                                                                    didTimeout: false,
                                                                    time: shared_user_1.bigNumberify(ok_r_1.blockNumber)
                                                                } }];
                                                }
                                            });
                                        };
                                        _a.label = 2;
                                    case 2:
                                        if (!(!timeout_delay || shared_backend_1.lt(block_poll_start, add(lastBlock, timeout_delay)))) return [3 /*break*/, 4];
                                    ...
                                    case 3:
                                        ...
                                        return [3 /*break*/, 2];
                                    case 4:
                                        shared_impl_1.debug(shad, ':', label, 'recv', ok_evt, timeout_delay, '--- TIMEOUT');
                                        return [2 /*return*/, { didTimeout: true }];
                                }
                            });
                        }); };
                        var recv = function (okNum, ok_cnt, out_tys, waitIfNotPresent, timeout_delay) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        void (ok_cnt);
                        ...
                        var wait = function (delta) { return __awaiter(_this, void 0, void 0, function () {
                            var lastBlock, p;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, getLastBlock()];
                                    case 1:
                                        lastBlock = _a.sent();
                                        // Don't wait from current time, wait from last_block
                                        shared_impl_1.debug('=====Waiting', delta, 'from', lastBlock, ':', address);
                                        return [4 /*yield*/, waitUntilTime(add(lastBlock, delta))];
                                    case 2:
                                        p = _a.sent();
                                        shared_impl_1.debug('=====Done waiting', delta, 'from', lastBlock, ':', address);
                                        return [2 /*return*/, p];
                                }
                            });
                        }); };
                        var creationTime = function () { return __awaiter(_this, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = shared_user_1.bigNumberify;
    ...
    // onProgress callback is optional, it will be given an obj
    // {currentTime, targetTime}
    var waitUntilTime = function (targetTime, onProgress) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    targetTime = shared_user_1.bigNumberify(targetTime);
                    if (!isIsolatedNetwork()) return [3 /*break*/, 2];
                    return [4 /*yield*/, fastForwardTo(targetTime, onProgress)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2: return [4 /*yield*/, actuallyWaitUntilTime(targetTime, onProgress)];
                case 3: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    shared_impl_1.debug('verifyContract:', address);
                    shared_impl_1.debug(ctcInfo);
                    shared_impl_1.debug('verifyContract: checking for receipt by txn hash', transactionHash);
                    return [4 /*yield*/, fetchAndRejectInvalidReceiptFor(transactionHash)];
                case 1:
                    r = _b.sent();
                    shared_impl_1.debug('verifyContract: got receipt', r);
                    return [4 /*yield*/, getProvider()];
                case 2:
                    provider = _b.sent();
                ...
                case 3:
                    ...
                    shared_impl_1.debug('Failed to fetch logs. Waiting some more before we try again', { tries: tries, creation_block: creation_block, now: now, waitTillBlock: waitTillBlock });
                    // Let logs show up by just waiting for another block
                    // https://github.com/reach-sh/reach-lang/issues/134
                    return [4 /*yield*/, waitUntilTime(shared_user_1.bigNumberify(waitTillBlock))];
                case 4:
                    // Let logs show up by just waiting for another block
                    // https://github.com/reach-sh/reach-lang/issues/134
                    _b.sent();
                    _b.label = 5;
                case 5: return [4 /*yield*/, getNetworkTimeNumber()];
                case 6:
                    now = _b.sent();
                    deployEvent = isNone(argsMay) ? 'e0' : 'e1';
                    shared_impl_1.debug('verifyContract: checking logs for', deployEvent, 'from', creation_block, 'to', now, '...');
