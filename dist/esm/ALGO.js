...
import { getViewsHelper, deferContract, debug, envDefault, argsSlice, argsSplit, makeRandom, replaceableThunk, ensureConnectorAvailable, bigNumberToBigInt, argMax, argMin, make_newTestAccounts, make_waitUntilX, checkTimeout, } from './shared_impl';
...
var _h = replaceableThunk(function () { return 0; }), _getQueryLowerBound = _h[0], _setQueryLowerBound = _h[1];
...
var _j = replaceableThunk(function () { return __awaiter(void 0, void 0, void 0, function () {
    var FAUCET;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                                            ...
                                            _loop_1 = function () {
                                                ...
                                                return __generator(this, function (_f) {
                                                    switch (_f.label) {
                                                        ...
                                                        case 8: return [2 /*return*/, (_d.value = _f.sent(), _d)];
                                                        case 9:
                                                            if (timeoutAt) {
                                                        ...
                                                        case 10:
                                                            _e = {};
                                                            return [4 /*yield*/, doRecv(false)];
                                                        case 11: return [2 /*return*/, (_e.value = _f.sent(), _e)];
                                                    }
                                                });
                                            };
                                            _c.label = 6;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                _b.label = 3;
            case 3: return [4 /*yield*/, indexer_statusAfterBlock(bigNumberToNumber(target))];
