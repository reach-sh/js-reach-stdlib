...
export var load = function () {
    ...
    var _a = __read(makeSigningMonitor(), 2), setSigningMonitor = _a[0], notifySend = _a[1];
    // module-wide config
    ...
    var addressEq = stdlib.addressEq, assert = stdlib.assert, gt = stdlib.gt, protect = stdlib.protect, simTokenAccepted_ = stdlib.simTokenAccepted_, digest = stdlib.digest;
    var T_UInt = typeDefs.T_UInt, T_Tuple = typeDefs.T_Tuple, T_Contract = typeDefs.T_Contract, T_Bytes = typeDefs.T_Bytes, T_Address = typeDefs.T_Address, T_Digest = typeDefs.T_Digest, T_Null = typeDefs.T_Null;
    var _b = makeRandom(8), randomUInt = _b.randomUInt, hasRandom = _b.hasRandom;
    ...
    var _c = __read(replaceableThunk(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var _d = __read(replaceableThunk(function () { return __awaiter(void 0, void 0, void 0, function () {
        var FAUCET;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var makeLogRep = function (evt, tys) {
        ...
        debug("makeLogRep", { evt: evt, sc: sc });
        var parse = function (log) {
            ...
            debug("parse", { log: log });
            // @ts-ignore
            var _a = __read(T_Tuple(__spreadArray([bytestringyNet(sigLen)], __read(tys), false)).fromNet(reNetify(log))), logb = _a[0], pd = _a.slice(1);
    ...
    var makeGetKey = function (mapi) { return function (kt, k, vt) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            debug('makeGetKey', { mapi: mapi, kt: kt, k: k, vt: vt });
            la = kt.netSize;
            isByte = mapi <= 255;
            rawLen = 1 + la;
            canBeRaw = isByte && rawLen <= algoMaxAppKeyLen;
            debug('makeGetKey', { la: la, isByte: isByte, rawLen: rawLen, canBeRaw: canBeRaw });
            r = (canBeRaw ? (function () {
                var bs = ethers.utils.concat([new Uint8Array([mapi]), kt.toNet(k)]);
                debug('makeGetKey', { bs: bs });
                return buf_to_hex(arr_to_buf(bs));
            }) : (function () {
                var mapit = T_UInt;
                return digest([mapit, kt], [mapi, k]);
            }))();
            debug('makeGetKey', { r: r });
            rlen = (r.length - 2) / 2;
            len = rlen + vt.netSize;
            mbr = 2500 + 400 * len;
                                ...
                                case 3:
                                    ...
                                    viewMapRef = function (mapi, kt, k, vt) { return __awaiter(void 0, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    debug('viewMapRef', { mapi: mapi, kt: kt, k: k, vt: vt });
                                                    return [4 /*yield*/, makeGetKey(mapi)(kt, k, vt)];
                                                case 1:
                                                    _a = __read.apply(void 0, [_b.sent(), 2]), f = _a[0], mbr = _a[1];
                                                    void mbr;
                                                    debug('viewMapRef', { f: f });
                                                    return [4 /*yield*/, getApplicationBoxM(ApplicationID, buf_to_arr(hex_to_buf(f)))];
                                                case 2:
                                                    vbsm = _b.sent();
                                                    debug('viewMapRef', { vbsm: vbsm });
                                                    if ('exn' in vbsm) {
                                                        return [2 /*return*/, ['None', null]];
                                                    }
                                                    v = vt.fromNet(vbsm.val);
                                                    debug('viewMapRef', { v: v });
                        ...
                        return __generator(this, function (_m) {
                            switch (_m.label) {
                                ...
                                case 9:
                                    ...
                                    isHalt = sim_r.isHalt;
                                    appIndex = bigNumberToNumber(ApplicationID);
                                    _loop_1 = function () {
                                            ...
                                            switch (_v.label) {
                                                ...
                                                case 10:
                                                    ...
                                                    if (hasCompanion) {
                                                        ...
                                                        debug('companion', { whichApi: whichApi, ccPublish: ccPublish, ccApi: ccApi, companionCalls: companionCalls, companionInfo: companionInfo });
                                                        if (companionCalls > 0) {
                                                ...
                                                case 13:
                                                    ...
                                                    debug(dhead, { boxesArr: boxesArr, boxesVal: boxesVal });
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    debug(dhead, { raw_ctc_evt: raw_ctc_evt });
    ...
    var balancesOf = function (acc, tokens) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1: return [2 /*return*/, (_a.sent()).map(function (bal) { return bal == false ? bigNumberify(0) : bal; })];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, bigNumberify(st['last-round'])];
                case 4:
                    e_15 = _a.sent();
                    debug("getNetworkTime", "node failed", e_15);
                    return [4 /*yield*/, getIndexer()];
                case 5:
                    indexer = _a.sent();
    ...
    var getTimeSecs = function (now_bn) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    e_16 = _a.sent();
                    debug("getTimeSecs", "node failed", e_16);
                    return [4 /*yield*/, getIndexer()];
                case 6:
                    indexer = _a.sent();
