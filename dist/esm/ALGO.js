...
import { getViewsHelper, deferContract, debug, envDefault, argsSplit, makeRandom, replaceableThunk, ensureConnectorAvailable, bigNumberToBigInt, argMax, argMin, make_newTestAccounts, make_waitUntilX, checkTimeout, truthyEnv, Signal, } from './shared_impl';
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        _g = [Deployer];
                        return [4 /*yield*/, getTxnParams()];
                    case 2: return [4 /*yield*/, _b.apply(void 0, _c.concat([_d.apply(void 0, [_f.apply(_e, _g.concat([_h.sent(), algosdk.OnApplicationComplete.NoOpOC,
                                    appApproval.result,
                                    appClear.result,
