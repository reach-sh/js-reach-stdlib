...
import { simTokenAccepted_ } from './shared_backend';
...
export var load = function () {
    ...
    var addressEq = stdlib.addressEq, assert = stdlib.assert, gt = stdlib.gt, protect = stdlib.protect;
    var T_UInt = typeDefs.T_UInt, T_Tuple = typeDefs.T_Tuple, T_Contract = typeDefs.T_Contract, T_Bytes = typeDefs.T_Bytes, T_Address = typeDefs.T_Address, T_Digest = typeDefs.T_Digest;
