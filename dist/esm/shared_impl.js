...
export var stdGetABI = function (ABI) { return function (isFull) {
...
export var makeDigest = function (mode, prep) { return function (ts_, vs_) {
    ...
    var r = f(kekCat);
    debug('digest', { mode: mode, prep: prep, ts: ts, vs: vs, kekCat: kekCat, f: f, r: r });
...
export var make_waitUntilX = function (label, getCurrent, step) { return function (target, onProgress) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var nextUpToTime = function (maxTime) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    if (_a) {
                        debug(dhead, "timeout", { maxTime: maxTime, r: r });
...
export var makeParseCurrency = function (defaultDecs) { return function (amt, decimals) {
