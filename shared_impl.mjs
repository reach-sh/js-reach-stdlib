...
import { bigNumberify, unk_to_buf, buf_to_arr, } from './CBR.mjs';
...
export var makeDigest = function(mode, prep) {
  return function(ts_, vs_) {
    var _a = __read(Array.isArray(ts_) ? [ts_, vs_] : [
        [ts_],
        [vs_]
      ], 2),
      ts = _a[0],
...
export var makeEventStream = function(args) {
  ...
  var nextUpToTime = function(maxTime) {
    return __awaiter(void 0, void 0, void 0, function() {
  ...
  var next = function() {
    return __awaiter(void 0, void 0, void 0, function() {
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/ , nextUpToTime(undefined)];
          case 1:
