...
export var doCall = ethLike.doCall,
  ...
  balancesOf = ethLike.balancesOf,
  minimumBalanceOf = ethLike.minimumBalanceOf,
  ...
  getTimeSecs = ethLike.getTimeSecs,
  ...
  setMinMillisBetweenRequests = ethLike.setMinMillisBetweenRequests,
  setCustomHttpEventHandler = ethLike.setCustomHttpEventHandler,
  setSigningMonitor = ethLike.setSigningMonitor;
export var add = reachStdlib.add,
  sub = reachStdlib.sub,
  mod = reachStdlib.mod,
  mul = reachStdlib.mul,
  div = reachStdlib.div,
  band = reachStdlib.band,
  bior = reachStdlib.bior,
  bxor = reachStdlib.bxor,
  eq = reachStdlib.eq,
  ge = reachStdlib.ge,
  gt = reachStdlib.gt,
  le = reachStdlib.le,
  lt = reachStdlib.lt,
  add256 = reachStdlib.add256,
  sub256 = reachStdlib.sub256,
  mod256 = reachStdlib.mod256,
  mul256 = reachStdlib.mul256,
  div256 = reachStdlib.div256,
  band256 = reachStdlib.band256,
  bior256 = reachStdlib.bior256,
  bxor256 = reachStdlib.bxor256,
  eq256 = reachStdlib.eq256,
  ge256 = reachStdlib.ge256,
  gt256 = reachStdlib.gt256,
  le256 = reachStdlib.le256,
  lt256 = reachStdlib.lt256,
  sqrt = reachStdlib.sqrt,
  sqrt256 = reachStdlib.sqrt256,
  cast = reachStdlib.cast,
  muldiv = reachStdlib.muldiv,
